...
# }
# 
# explain <- lime(trainData[,-1], fit.svm) #, bin_continuous = TRUE, n_bins = 5, n_permutations = 1000)
...
# pred <- data.frame(sample_id = 1:nrow(testData2),
#                    Prediction_SVM,
#                    actual = testData2$TARGET_heart_disease_present)
#   pred$prediction <- pred$Prediction_SVM
...
# 
# test_data_cor <- testData2 %>%
#   mutate(sample_id = 1:nrow(testData2)) %>%
...
#   dplyr::select(-TARGET_heart_disease_present)
#   
# model_type.SVM(fit.svm)
# predict_model.SVM(fit.svm, testData2)
# explanation_cor <- lime::explain(test_data_cor, explain, n_labels = 1, n_features = 2)
# explanation_wrong <- lime::explain(test_data_wrong, explain, n_labels = 1, n_features = 2)
# 
...
#plot_explanations(explainer.model.svm)
